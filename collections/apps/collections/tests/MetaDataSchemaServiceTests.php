...
include_once('service/MetadataSchemaService.php');
include_once('tests/mocks/OC.php');
...
class MetaDataSchemaServiceTests extends TestCase {
    ...
    public function testValidateMetadataSchemaPrevalidated() {
        ...
        $valid = Helper::invokeMethod($this->metaDataSchemaService, 'isMetadataSchemaValid', [$contents, NULL]);
    ...
    public function testProcessAccessListHasNoDuplicates() {
        ...
        $actual = Helper::invokeMethod($this->metaDataSchemaService, 'processAccessList', $params);
